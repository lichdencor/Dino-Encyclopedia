      ...
      <Nav />
        <div className="triassic-inferior-bg">
            ...
            <div className=" bg-era">
                ...
                <div className="name-frame name-frame-1">Postosuchus</div>
                <div className="name-frame name-frame-2">Eoraptor</div>
                <div className="name-frame name-frame-3">Herrerasaurus</div>
