...
export const TriassicSuperior = () => {
  ...
  return (
    <div>
      <Nav />
      <div className={styles.triassicSuperiorContainer}>
        <div
        ...
        <div className={styles.triassicSuperiorBg} style={{ pointerEvents: "none" }}></div>

        <GalleryArrows page1="triassic-medium" page2="jurassic-inferior" />
        <GalleryDinosaurNames dinosaurs={superiorTriassicData?.dinosaurs.map(dino => dino.name) || []}></GalleryDinosaurNames>
        ...
        {isModalOpen && dinosaursInfo[selectedDinosaur] &&
            <XRayModal
              ...
              dinosaurImage={`/assets/img/dinosaurs/tr-3-${dinosaursInfo[selectedDinosaur].name}.png`}
              dinosaurBone={`/assets/img/dinosaurs/skeleton/skeleton-tr-3-${dinosaursInfo[selectedDinosaur].name}.png`}
            />
        }
      </div>
    </div>
