...
export const CretaceousSuperior = () => {
  ...
  return (
    <div>
      <Nav />
      <div className={styles.cretaceousSuperiorContainer}>
        <div
        ...
        <div className={styles.cretaceousSuperiorBg} style={{ pointerEvents: "none" }}></div>

        <GalleryArrows page1="cretaceous-medium" page2="map" />
        <GalleryDinosaurNames dinosaurs={superiorCretaceousData?.dinosaurs.map(dino => dino.name) || []}></GalleryDinosaurNames>
        ...
        {isModalOpen && dinosaursInfo[selectedDinosaur] &&
            <XRayModal
              ...
              dinosaurImage={`/assets/img/dinosaurs/cr-3-${dinosaursInfo[selectedDinosaur].name}.png`}
              dinosaurBone={`/assets/img/dinosaurs/skeleton/skeleton-cr-3-${dinosaursInfo[selectedDinosaur].name}.png`}
            />
        }
      </div>
    </div>
