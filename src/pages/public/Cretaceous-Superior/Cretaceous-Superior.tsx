      ...
      <Nav />
        <div class="triassic-inferior-bg">
            ...
            <div class=" bg-era">
                ...
                <div class="name-frame name-frame-1">Triceratops</div>
                <div class="name-frame name-frame-2">Ankylosaurus</div>
                <div class="name-frame name-frame-3">Tyrannosaurus Rex</div>
